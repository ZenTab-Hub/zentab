...
import {
  ...
  Palette, Bot, Code2, Settings2, Info, ShieldCheck,
} from 'lucide-react'
...
type Tab = 'appearance' | 'ai' | 'editor' | 'general' | 'security' | 'about'
...
export const SettingsModal = ({ isOpen, onClose }: SettingsModalProps) => {
  ...
  const TabContent = { appearance: AppearanceTab, ai: AIModelsTab, editor: EditorTab, general: GeneralTab, security: SecurityTab, about: AboutTab }[activeTab]
  return (
